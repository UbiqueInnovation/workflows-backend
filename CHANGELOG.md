...
Previously, jib-maven-plugin was defined inside the project poms, yet now it is. All projects need to have their usages of mvn_docker_image.yml@main updated to mvn_docker_image.yml@v1 or do the following changes in their poms:
